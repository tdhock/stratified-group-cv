...
A previous heuristic in scikit-learn assigns by minimizing variance between folds, but is quadratic time.
We propose a new heuristic assignment that minimizes squared error between ideal and actual counts per fold and stratum.
We 
